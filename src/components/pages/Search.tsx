...
const Search: React.FC<SearchProps> = ({ cid }) => {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center text-center text-white h-64 bg-[#2D2D2D] rounded-2xl">
  ...
  if (fileInfo && fileInfo.manifest) {
    ...
    return (
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-white">Search Result</h2>
        <FileCard
